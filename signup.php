...
<body style="background: url(assets/image/minimalism_icon_computer_66194_1920x1080.jpg); background-size: cover;" class="trans">
        ...
        <center>
            <div style="padding-top: 125px;">
                <a href="index.php" onclick="window.close();">
                    <img src="assets/image/logo4.png" class="img-responsive" style="width: 100px; height: 100px;">
                </a>
