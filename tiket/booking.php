...
<head>
    <title>Planesia | Penyedia Tiket terlucu</title>
            ...
            <div class="col s7">
                <div class="card-panel">
                    ...
                    <form method="post" action="pesan_p.php">
                        ...
                        <button class="btn waves-effect"></i> Tambah Makanan</button>
                        <button class="btn waves-effect"></i> Tambah Souvenir</button>
                        <button class="btn waves-effect-mt-5"><i class="ion-load-c"></i> Booking</button>
                    </form>
                </div>
            </div>
        </div>
